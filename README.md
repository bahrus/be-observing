...
"e" stands for "event", "f" stands for "factors".

Advantages of this approach:

1.  Total locality of behavior, cut/copy/paste easier
2.  No need for the defer, even in a site that doesn't use bundling.
3.  Can have multiple statements within the attribute, each with its own little JS scriptlet if needed.
